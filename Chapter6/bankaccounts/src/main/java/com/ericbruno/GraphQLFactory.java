...
public class GraphQLFactory {
    ...
    public GraphQL graphQL(ResourceResolver resourceResolver,
            ...
            AddTransactionDataFetcher addTransactionDF,
            NewBalanceDataFetcher newBalanceDF) 
    {
        // Make sure a GraphQL schema file exists for this project
        Optional<InputStream> graphqlSchemaFileIS = 
        ...
        RuntimeWiring runtimeWiring = RuntimeWiring.newRuntimeWiring()
                ...
                .type("Mutation", typeWiring -> typeWiring
                    ...
                    .dataFetcher("addTransaction", addTransactionDF))
                .type("Subscription", typeWiring -> typeWiring
                    .dataFetcher("newBalance", newBalanceDF))
                .type("SubscriptionRoot", typeWiring -> typeWiring
                        .dataFetcher("stream", newBalanceDF))
